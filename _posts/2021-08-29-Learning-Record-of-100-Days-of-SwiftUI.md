...
- `Spacer().frame(height: 0)` create spacer with flexible width
- apply `.font(.title)` on `Image` can show image larger
...
- `@EnvironmentObject` property must conform to `ObservableObject`
- `@EnvironmentObject` only works with `class`

## Day 84

[Practice Code](https://github.com/HevaWu/100DaysOfSwiftUI/compare/v0.83.0...v0.84.0)

## Day 83

[Practice Code](https://github.com/HevaWu/100DaysOfSwiftUI/compare/v0.82.0...v0.83.0)

- `.textContentType()` modifier to TextField to tell what kind of information this is asking for
  - system use this information to offer suggestions while user enter text on iOS or tvOS
